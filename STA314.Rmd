...
result <- mvn(data = lasso_selected_variables, mvnTest = "hz")
result$multivariateNormality

boxM(lasso_selected_variables, y)
```
...
results <- data.frame(
  ...
  `CV Accuracy` = c(0.7240691, 0.7107713, 0.7220504),
  `CV Recall` = c(0.5338346, 0.6218487, 0.8044919),
...
results %>%
  kbl(caption = "Cross-Validation and Validation Metrics by Model") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"),
                full_width = F,
                font_size = 14) %>%
  column_spec(1, bold = T, background = "#F7F7F7") %>%
